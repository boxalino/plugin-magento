...
class Boxalino_Exporter_Helper_Data extends Mage_Core_Helper_Data
{
	...
	public function rewrittenProductUrl($productId, $storeId)
    {
        ...
        return $this->_getFullProductUrl($product);
    }
 
    protected function _getFullProductUrl(Mage_Catalog_Model_Product $product = null)
    {
        ...
        if ($productPath !== false) {
            if ($categoryPath) {
                // Only use the category path if one is found.
