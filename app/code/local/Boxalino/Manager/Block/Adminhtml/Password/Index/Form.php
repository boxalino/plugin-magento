...
class Boxalino_Manager_Block_Adminhtml_Password_Index_Form extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_password_index';
        $this->_mode = 'view';
